...
public class MainActivityOld extends AppCompatActivity implements View.OnClickListener, OneClickPaymentListener {
...
//    int env = PayuConstants.PRODUCTION_ENV;
    ...
    String merchantTestKeys[] = {"gtKFFx","obScKz", "smsplus"};//
//    String merchantTestSalts[] = {"Ml7XBCdR","GEIXyidM","eCwWELxi", "350" };
    ...
    String merchantKey =
            env == PayuConstants.PRODUCTION_ENV ? merchantProductionKeys[merchantIndex]:merchantTestKeys[merchantIndex];
//    String merchantSalt = env == PayuConstants.PRODUCTION_ENV ? merchantProductionSalts[merchantIndex] : merchantTestSalts[merchantIndex];
    ...
    String mandatoryValues[] = { merchantKey, "10.0", "myproduct", "firstname", "me@itsmeonly.com", ""+System.currentTimeMillis(),
            "https://payu.herokuapp.com/success123",
            "https://payu.herokuapp.com/failure123",
            merchantKey+":payutest@payu.in", "udf1", "udf2", "udf3", "udf4", "udf5", ""+env, ""+PayuConstants.STORE_ONE_CLICK_HASH_SERVER };
...
//                new AlertDialog.Builder(this)
//                        .setCancelable(false)
//                        .setMessage(data.getStringExtra(PayuConstants.PAYU_RESPONSE)/*data.getStringExtra("result")*/)
//                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
//                            public void onClick(DialogInterface dialog, int whichButton) {
//
//                            }
...
//                    payuConfig.setEnvironment(Integer.valueOf(environment));
        ...
        //salt = //"GEIXyidM";//"eCwWELxi";
        //mPaymentParams.setOfferKey("guru_offer@7260");
